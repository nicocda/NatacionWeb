...
//Torneo
			...
			{
				return ct.buscarTorneo(nroTorneo);
			}
...
//Serie
			...
			public ArrayList<Nadador> buscarMuchosNadadoresPorDniPosta(Carrera carreraSeleccionada, int nroTorneo, int dni) {
				return CatalogoNadadores.getInstance().buscarMuchosNadadoresPorDniPosta(carreraSeleccionada, nroTorneo, dni);
			}
			public ArrayList<Nadador> buscarMuchosNadadoresPorNombreYApellidoPosta(Carrera carreraSeleccionada,
					int nroTorneo, String nombre) {
		
				return CatalogoNadadores.getInstance().buscarMuchosNadadoresPorNombreYApellidoPosta(carreraSeleccionada, nroTorneo, nombre);
			}
